...
class ClassroomsConfig(AppConfig):
    ...
    def ready(self):
        ...
        # Connect the post_migrate signal to populate gradelevels and classrooms after migrations are complete
        post_migrate.connect(populate_gradelevels_and_classrooms, sender=self)
